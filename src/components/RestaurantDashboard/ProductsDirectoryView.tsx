...
export const ProductsDirectoryView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in text-left font-sans">
      ...
      {isLoading ? (
        ...
        /* Empty State */
        <div className="bg-white border border-[#e8e2d8] p-16 text-center rounded shadow-sm max-w-2xl mx-auto w-full my-8">
          <span className="material-symbols-outlined text-text-muted text-6xl">
            inventory_2
          </span>
          <h3 className="text-h3 font-black text-[#222222] mt-4 uppercase font-sans">
            No products found
          </h3>
          <p className="text-body-md text-[#666666] mt-2 font-sans max-w-md mx-auto">
            No products found. Click 'Add Product' to start building your catalog.
          </p>
          <button
            onClick={handleOpenAddModal}
            className="mt-6 px-6 py-2.5 bg-[#ae001a] text-white font-bold text-label-caps hover:bg-[#d2272f] transition-all rounded flex items-center gap-2 mx-auto font-sans shadow-md"
          >
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="divide-y divide-[#e8e2d8]">
                {filteredProducts.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-6 py-8 text-center text-secondary italic font-sans">
                        ...
                        <td className="px-6 py-4 text-right">
                          <div className="flex justify-end gap-2">
                            ...
                            <button
                              ...
                              className="p-1 text-[#1d1c17] hover:text-[#ba1a1a] transition-colors cursor-pointer"
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 z-[9999] flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white border border-[#e8e2d8] rounded shadow-2xl w-full max-w-md overflow-hidden animate-fade-in text-left">
...
export default ProductsDirectoryView;
